...
public class JDBCTemplate {
	...
	// 2. 전달받은 JDBC 용 객체를 반납시켜주는 메서드(각 객체별로)
	// 2_1)) Connection 객체를 전달받아서 반납시켜주는 메서드
	public static void close(Connection conn) {
		try {
			// 주의사항!
			// 만약에 conn 이 null 이라면 NullpointerException 발생할 수 있음
	...
	// 3_1) 전달받은 Connection 객체를 가지고 COMMUIT 시켜주는 메서드
	...
	// 3_2) 전달받은 Connection 객체를 가지고 ROLLBACK 시켜주는 메서드
